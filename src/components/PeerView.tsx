...
const PeerView = () => {
  ...
  return (
    <div className="w-[50%] h-auto flex flex-col justify-start items-start gap-2 mb-4">
      <div className="w-full flex flex-row justify-between items-start">
        <div className="flex flex-row justify-start items-start">
          ...
          >
            ...
            <div className="absolute bottom-1 h-[1.4rem] w-[3rem] rounded-md bg-primaryPurple text-white font-rubik font-semibold text-[0.7rem] flex flex-col justify-center items-center">
              LIVE
            </div>
          </div>
          <div className="w-[80%] flex flex-col justify-start items-start ml-4">
            ...
            >
              <span className="text-textPurple font-rubik font-bold mx-3">
                {streamerData?.name}
              </span>
            </div>
            <span
        ...
        <div className="flex flex-col justify-between items-end h-full">
          <span className="text-textPurple font-rubik font-semibold text-[1.2rem]">
      ...
      <div className="w-full h-full aspect-video bg-secondaryPurple/10 border-solid border-[1px] border-primaryPurple rounded-xl relative overflow-hidden mt-4 border-shadow">
        {Object.values(peers)
      ...
      <div className="w-full flex flex-row justify-between items-center mt-4">
        <div className="flex flex-row justify-start items-center">
          ...
          >
            ...
            ></PeopleIcon>
            <span className="text-textPurple font-rubik font-medium text-[1rem] ml-8">
              4500
            </span>
            <span className="text-textPurple font-rubik font-normal text-[0.8rem]">
              live viewers
            </span>
          </div>
          <ShareIcon
      ...
      <div className="grid grid-flow-row grid-cols-4 gap-4 h-auto w-full mt-6">
        {streamCategories?.map((category, index) => (
          <div
            key={index}
            className="w-auto px-2 h-[2.4rem] bg-primaryPurple rounded-2xl flex flex-row justify-center items-center text-white font-rubik font-bold text-[0.8rem] cursor-pointer"
          >
            {category}
          </div>
        ))}
