    ...
    <div className="flex flex-row w-[90%] h-auto mt-8">
      <div className="h-auto flex flex-col justify-start items-center">
        ...
        <div className="flex flex-col justify-start items-center mt-10">
          <span
            className="text-primaryPurple font-rubik text-lg font-bold"
            onClick={() => {
        ...
        <div className="flex flex-col justify-start items-center mt-4">
          <span className="text-primaryPurple font-rubik text-lg font-bold">
            Following
          </span>
          <span className="text-white font-rubik text-lg font-bold">
      ...
      <div className="flex flex-col justify-start items-start w-[45%] h-auto ml-12 gap-4">
        <div className="flex flex-row justify-between items-center w-full">
          <div className="h-[4.5rem] w-full rounded-lg text-primaryPurple drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] text-[3rem] font-dieNasty">
        ...
        <div className="grid grid-flow-row grid-cols-4 gap-4 h-[8rem] w-full mt-12">
          {(isRouterQuery ? (streamerCategories as string[]) : categories).map(
            (category, index) => (
              <div
                key={index}
                className="w-auto px-2 h-[2.4rem] rounded-2xl flex flex-row justify-center items-center text-white font-rubik font-bold text-[0.8rem] bg-primaryPurple"
              >
                {category}
              </div>
            )
