  ...
  return (
    <div className="w-full h-auto">
      {chat.isSubscriber || chat.sender == streamData?.streamer ? (
        <span className="w-full h-auto flex flex-row justify-start items-baseline bg-secondaryPurple/20 border-primaryPurple border-[1px] border-solid py-2 px-3 rounded-xl">
          <span
