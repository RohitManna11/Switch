  ...
  return (
    ...
    >
      ...
      <div className="w-[95%] h-auto flex-col justify-start items-start mt-2">
        <div className="w-full flex flex-row justify-between items-center">
          <div className="w-[85%] h-[2.5rem] border-primaryPurple border-2 border-solid rounded-md bg-[#1c1c1e] px-2 flex flex-col justify-center items-start">
            <textarea
              id="message"
          ...
          <div
            className={`rounded-full w-[3rem] h-[3rem] ${
              handleAllCheck()
                ? "bg-secondaryPurple border-[1px] border-primaryPurple border-solid cursor-pointer"
                : "bg-secondaryGrey"
        ...
        {!(address == streamData?.streamer) && (
          ...
          >
            <div className="w-[20%] h-[2rem] border-primaryPurple border-2 border-solid rounded-md bg-[#1c1c1e] px-2 flex flex-col justify-center items-start">
              <input
                type="number"
                min={0}
                id="amount"
