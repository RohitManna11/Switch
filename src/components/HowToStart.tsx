...
const HowToStart = () => {
  return (
    <div className="w-[40%] h-full bg-secondaryPurple/10 rounded-lg border-primaryPurple border-[1px] ml-10 flex flex-col justify-start items-center p-4 gap-4 overflow-scroll">
