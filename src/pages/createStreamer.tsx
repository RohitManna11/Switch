          ...
          <div className="w-[60%] flex flex-col justify-start items-start gap-2">
            ...
            <div className="h-[4rem] w-full bg-secondaryGrey rounded-sm pl-4">
              <input
                type="text"
                id="name"
                className="appearance-none bg-transparent border-none outline-none text-primaryPurple drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] text-[2.5rem] font-dieNasty"
                onChange={(e: any) => {
                  handleNameChange(e);
                }}
              />
        ...
        <div className="w-full flex flex-col justify-start items-start gap-2">
          ...
          <div className="w-[20%] bg-secondaryGrey rounded-sm pl-4">
            <input
              ...
              min={0}
              id="nftSupply"
              className="appearance-none bg-transparent w-full border-none outline-none text-primaryPurple drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] text-[2.5rem] font-dieNasty"
              onChange={(e: any) => {
