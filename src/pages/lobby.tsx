      ...
      <div className="h-auto w-[90%] flex mt-10 flex-row justify-between items-start px-10 mb-10">
        <div className="h-[80vh] flex flex-col justify-start items-start">
          <div className="flex flex-row justify-start items-center">
            ...
            <span className="text-textPurple font-rubik font-semibold text-[1.2rem] ml-2">
              {context.roomId}
            </span>
          </div>
          <div className="w-full h-80 aspect-video bg-secondaryPurple/10 border-solid border-[1px] border-primaryPurple rounded-xl relative overflow-hidden mt-4 border-shadow">
            {!cameraOn ? (
        ...
        <div className="w-[50%] h-auto flex flex-col justify-start items-start">
          <div
            className={`w-full h-auto flex flex-col justify-start items-start ${
              isExclusive
                ? "bg-secondaryPurple/20 border-primaryPurple border-[1px] border-solid"
                : "bg-primaryGrey"
            } p-8 gap-8`}
          >
              ...
              <div className="flex flex-row justify-start items-center gap-4">
                ...
                <div
                  className={`h-[1.5rem] w-[1.5rem] ${
                    isExclusive ? "bg-primaryPurple" : "bg-none"
